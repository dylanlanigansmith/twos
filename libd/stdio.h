...
static inline void* mkdir(void* l, int p) { ASSERT(1 == 0); return 0;}

static inline long int ftell(FILE *stream) { ASSERT(1 == 0); return 0; }
#define SEEK_SET 0

#define SEEK_CUR 1

#define SEEK_END 2
static inline int fseek(FILE *stream, long int offset, int whence) { ASSERT(1 == 0); return 0; }


static inline int remove ( const char * filename ) { ASSERT(1 == 0); return 0; }

static inline int rename ( const char * oldname, const char * newname ) { ASSERT(1 == 0); return 0; }
